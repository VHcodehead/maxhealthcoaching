  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(closest-side, oklch(0.68 0.20 245 / 0.30), transparent 70%)' }}
      />
      <div
        className="absolute bottom-[-220px] right-[-140px] h-[520px] w-[520px] rounded-full opacity-40 blur-[160px]"
        style={{ background: 'radial-gradient(closest-side, oklch(0.68 0.20 245 / 0.20), transparent 70%)' }}
      />
